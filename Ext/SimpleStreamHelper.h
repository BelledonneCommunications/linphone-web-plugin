...
namespace FBExt {
    ...
    public:
        ////////////////////////////////////////////////////////////////////////////////////////////////////
        /// @fn public static FB::SimpleStreamHelperPtr FB::SimpleStreamHelper::AsyncGet(const FB::BrowserHostPtr& host, const FB::URI& uri, const HttpCallback& callback,const HttpProgressCallback& progressCallback = HttpProgressCallback(), const bool cache = true, const size_t bufferSize = 128*1024)
        ///
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////
        /// @fn public static FB::SimpleStreamHelperPtr FB::SimpleStreamHelper::AsyncPost(const FB::BrowserHostPtr& host, const FB::URI& uri, const std::string& postdata, const HttpCallback& callback, const HttpProgressCallback& progressCallback = HttpProgressCallback(), const bool cache = true, const size_t bufferSize = 128*1024)
        ///

...
function (create_rootfs PROJNAME)
	SET(ROOTFS_SOURCES
		...
		${CMAKE_CURRENT_SOURCE_DIR}/Rootfs/lib/libavcodec.${DEPENDENCY_EXT}.53
		${CMAKE_CURRENT_SOURCE_DIR}/Rootfs/lib/libavutil.${DEPENDENCY_EXT}.51
		${CMAKE_CURRENT_SOURCE_DIR}/Rootfs/lib/libcrypto.${DEPENDENCY_EXT}.1.0.0
		${CMAKE_CURRENT_SOURCE_DIR}/Rootfs/lib/libeXosip2.${DEPENDENCY_EXT}.7
		${CMAKE_CURRENT_SOURCE_DIR}/Rootfs/lib/libjpeg.${DEPENDENCY_EXT}.8
		${CMAKE_CURRENT_SOURCE_DIR}/Rootfs/lib/liblinphone.${DEPENDENCY_EXT}.5
		${CMAKE_CURRENT_SOURCE_DIR}/Rootfs/lib/libmediastreamer_base.${DEPENDENCY_EXT}.3
		${CMAKE_CURRENT_SOURCE_DIR}/Rootfs/lib/libmediastreamer_voip.${DEPENDENCY_EXT}.3
		${CMAKE_CURRENT_SOURCE_DIR}/Rootfs/lib/libogg.${DEPENDENCY_EXT}.0
		${CMAKE_CURRENT_SOURCE_DIR}/Rootfs/lib/libortp.${DEPENDENCY_EXT}.9
		${CMAKE_CURRENT_SOURCE_DIR}/Rootfs/lib/libosip2.${DEPENDENCY_EXT}.7
		${CMAKE_CURRENT_SOURCE_DIR}/Rootfs/lib/libosipparser2.${DEPENDENCY_EXT}.7
		${CMAKE_CURRENT_SOURCE_DIR}/Rootfs/lib/libspeex.${DEPENDENCY_EXT}.1
		${CMAKE_CURRENT_SOURCE_DIR}/Rootfs/lib/libspeexdsp.${DEPENDENCY_EXT}.1
		${CMAKE_CURRENT_SOURCE_DIR}/Rootfs/lib/libssl.${DEPENDENCY_EXT}.1.0.0
		${CMAKE_CURRENT_SOURCE_DIR}/Rootfs/lib/libswscale.${DEPENDENCY_EXT}.2
		${CMAKE_CURRENT_SOURCE_DIR}/Rootfs/lib/libtheora.${DEPENDENCY_EXT}.0
		${CMAKE_CURRENT_SOURCE_DIR}/Rootfs/lib/libv4l1.${DEPENDENCY_EXT}.0
		${CMAKE_CURRENT_SOURCE_DIR}/Rootfs/lib/libv4l2.${DEPENDENCY_EXT}.0
		${CMAKE_CURRENT_SOURCE_DIR}/Rootfs/lib/libv4lconvert.${DEPENDENCY_EXT}.0
		${CMAKE_CURRENT_SOURCE_DIR}/Rootfs/lib/libvpx.${DEPENDENCY_EXT}.1
		${CMAKE_CURRENT_SOURCE_DIR}/Rootfs/lib/libz.${DEPENDENCY_EXT}.1
	...
	ADD_CUSTOM_COMMAND(OUTPUT ${FB_ROOTFS_DIR}
		...
		COMMAND ${CMAKE_COMMAND} -E copy ${CMAKE_CURRENT_SOURCE_DIR}/Rootfs/lib/libavcodec.${DEPENDENCY_EXT}.53 ${FB_ROOTFS_DIR}/${LINPHONEWEB_SHAREDIR}/
		COMMAND ${CMAKE_COMMAND} -E copy ${CMAKE_CURRENT_SOURCE_DIR}/Rootfs/lib/libavutil.${DEPENDENCY_EXT}.51 ${FB_ROOTFS_DIR}/${LINPHONEWEB_SHAREDIR}/
		COMMAND ${CMAKE_COMMAND} -E copy ${CMAKE_CURRENT_SOURCE_DIR}/Rootfs/lib/libcrypto.${DEPENDENCY_EXT}.1.0.0 ${FB_ROOTFS_DIR}/${LINPHONEWEB_SHAREDIR}/
		COMMAND ${CMAKE_COMMAND} -E copy ${CMAKE_CURRENT_SOURCE_DIR}/Rootfs/lib/libeXosip2.${DEPENDENCY_EXT}.7 ${FB_ROOTFS_DIR}/${LINPHONEWEB_SHAREDIR}/
		COMMAND ${CMAKE_COMMAND} -E copy ${CMAKE_CURRENT_SOURCE_DIR}/Rootfs/lib/libjpeg.${DEPENDENCY_EXT}.8 ${FB_ROOTFS_DIR}/${LINPHONEWEB_SHAREDIR}/
		COMMAND ${CMAKE_COMMAND} -E copy ${CMAKE_CURRENT_SOURCE_DIR}/Rootfs/lib/liblinphone.${DEPENDENCY_EXT}.5 ${FB_ROOTFS_DIR}/${LINPHONEWEB_SHAREDIR}/
		COMMAND ${CMAKE_COMMAND} -E copy ${CMAKE_CURRENT_SOURCE_DIR}/Rootfs/lib/libmediastreamer_base.${DEPENDENCY_EXT}.3 ${FB_ROOTFS_DIR}/${LINPHONEWEB_SHAREDIR}/
		COMMAND ${CMAKE_COMMAND} -E copy ${CMAKE_CURRENT_SOURCE_DIR}/Rootfs/lib/libmediastreamer_voip.${DEPENDENCY_EXT}.3 ${FB_ROOTFS_DIR}/${LINPHONEWEB_SHAREDIR}/
		COMMAND ${CMAKE_COMMAND} -E copy ${CMAKE_CURRENT_SOURCE_DIR}/Rootfs/lib/libogg.${DEPENDENCY_EXT}.0 ${FB_ROOTFS_DIR}/${LINPHONEWEB_SHAREDIR}/
		COMMAND ${CMAKE_COMMAND} -E copy ${CMAKE_CURRENT_SOURCE_DIR}/Rootfs/lib/libortp.${DEPENDENCY_EXT}.9 ${FB_ROOTFS_DIR}/${LINPHONEWEB_SHAREDIR}/
		COMMAND ${CMAKE_COMMAND} -E copy ${CMAKE_CURRENT_SOURCE_DIR}/Rootfs/lib/libosip2.${DEPENDENCY_EXT}.7 ${FB_ROOTFS_DIR}/${LINPHONEWEB_SHAREDIR}/
		COMMAND ${CMAKE_COMMAND} -E copy ${CMAKE_CURRENT_SOURCE_DIR}/Rootfs/lib/libosipparser2.${DEPENDENCY_EXT}.7 ${FB_ROOTFS_DIR}/${LINPHONEWEB_SHAREDIR}/
		COMMAND ${CMAKE_COMMAND} -E copy ${CMAKE_CURRENT_SOURCE_DIR}/Rootfs/lib/libspeex.${DEPENDENCY_EXT}.1 ${FB_ROOTFS_DIR}/${LINPHONEWEB_SHAREDIR}/
		COMMAND ${CMAKE_COMMAND} -E copy ${CMAKE_CURRENT_SOURCE_DIR}/Rootfs/lib/libspeexdsp.${DEPENDENCY_EXT}.1 ${FB_ROOTFS_DIR}/${LINPHONEWEB_SHAREDIR}/
		COMMAND ${CMAKE_COMMAND} -E copy ${CMAKE_CURRENT_SOURCE_DIR}/Rootfs/lib/libssl.${DEPENDENCY_EXT}.1.0.0 ${FB_ROOTFS_DIR}/${LINPHONEWEB_SHAREDIR}/
		COMMAND ${CMAKE_COMMAND} -E copy ${CMAKE_CURRENT_SOURCE_DIR}/Rootfs/lib/libswscale.${DEPENDENCY_EXT}.2 ${FB_ROOTFS_DIR}/${LINPHONEWEB_SHAREDIR}/
		COMMAND ${CMAKE_COMMAND} -E copy ${CMAKE_CURRENT_SOURCE_DIR}/Rootfs/lib/libtheora.${DEPENDENCY_EXT}.0 ${FB_ROOTFS_DIR}/${LINPHONEWEB_SHAREDIR}/
		COMMAND ${CMAKE_COMMAND} -E copy ${CMAKE_CURRENT_SOURCE_DIR}/Rootfs/lib/libv4l1.${DEPENDENCY_EXT}.0 ${FB_ROOTFS_DIR}/${LINPHONEWEB_SHAREDIR}/
		COMMAND ${CMAKE_COMMAND} -E copy ${CMAKE_CURRENT_SOURCE_DIR}/Rootfs/lib/libv4l2.${DEPENDENCY_EXT}.0 ${FB_ROOTFS_DIR}/${LINPHONEWEB_SHAREDIR}/
		COMMAND ${CMAKE_COMMAND} -E copy ${CMAKE_CURRENT_SOURCE_DIR}/Rootfs/lib/libv4lconvert.${DEPENDENCY_EXT}.0 ${FB_ROOTFS_DIR}/${LINPHONEWEB_SHAREDIR}/
		COMMAND ${CMAKE_COMMAND} -E copy ${CMAKE_CURRENT_SOURCE_DIR}/Rootfs/lib/libvpx.${DEPENDENCY_EXT}.1 ${FB_ROOTFS_DIR}/${LINPHONEWEB_SHAREDIR}/
		COMMAND ${CMAKE_COMMAND} -E copy ${CMAKE_CURRENT_SOURCE_DIR}/Rootfs/lib/libz.${DEPENDENCY_EXT}.1 ${FB_ROOTFS_DIR}/${LINPHONEWEB_SHAREDIR}/
		...
		## Change rpath
		COMMAND ${CMAKE_CHRPATH} -c -r \\\$$ORIGIN ${FB_ROOTFS_DIR}/${LINPHONEWEB_SHAREDIR}/libavcodec.${DEPENDENCY_EXT}.53
		COMMAND ${CMAKE_CHRPATH} -c -r \\\$$ORIGIN ${FB_ROOTFS_DIR}/${LINPHONEWEB_SHAREDIR}/libavutil.${DEPENDENCY_EXT}.51
#		COMMAND ${CMAKE_CHRPATH} -c -r \\\$$ORIGIN ${FB_ROOTFS_DIR}/${LINPHONEWEB_SHAREDIR}/libcrypto.${DEPENDENCY_EXT}.1.0.0
		COMMAND ${CMAKE_CHRPATH} -c -r \\\$$ORIGIN ${FB_ROOTFS_DIR}/${LINPHONEWEB_SHAREDIR}/libjpeg.${DEPENDENCY_EXT}.8
		COMMAND ${CMAKE_CHRPATH} -c -r \\\$$ORIGIN ${FB_ROOTFS_DIR}/${LINPHONEWEB_SHAREDIR}/libeXosip2.${DEPENDENCY_EXT}.7
		COMMAND ${CMAKE_CHRPATH} -c -r \\\$$ORIGIN ${FB_ROOTFS_DIR}/${LINPHONEWEB_SHAREDIR}/liblinphone.${DEPENDENCY_EXT}.5
		COMMAND ${CMAKE_CHRPATH} -c -r \\\$$ORIGIN ${FB_ROOTFS_DIR}/${LINPHONEWEB_SHAREDIR}/libmediastreamer_base.${DEPENDENCY_EXT}.3
		COMMAND ${CMAKE_CHRPATH} -c -r \\\$$ORIGIN ${FB_ROOTFS_DIR}/${LINPHONEWEB_SHAREDIR}/libmediastreamer_voip.${DEPENDENCY_EXT}.3
		COMMAND ${CMAKE_CHRPATH} -c -r \\\$$ORIGIN ${FB_ROOTFS_DIR}/${LINPHONEWEB_SHAREDIR}/libogg.${DEPENDENCY_EXT}.0
		COMMAND ${CMAKE_CHRPATH} -c -r \\\$$ORIGIN ${FB_ROOTFS_DIR}/${LINPHONEWEB_SHAREDIR}/libortp.${DEPENDENCY_EXT}.9
		COMMAND ${CMAKE_CHRPATH} -c -r \\\$$ORIGIN ${FB_ROOTFS_DIR}/${LINPHONEWEB_SHAREDIR}/libosip2.${DEPENDENCY_EXT}.7
		COMMAND ${CMAKE_CHRPATH} -c -r \\\$$ORIGIN ${FB_ROOTFS_DIR}/${LINPHONEWEB_SHAREDIR}/libosipparser2.${DEPENDENCY_EXT}.7
		COMMAND ${CMAKE_CHRPATH} -c -r \\\$$ORIGIN ${FB_ROOTFS_DIR}/${LINPHONEWEB_SHAREDIR}/libspeex.${DEPENDENCY_EXT}.1
		COMMAND ${CMAKE_CHRPATH} -c -r \\\$$ORIGIN ${FB_ROOTFS_DIR}/${LINPHONEWEB_SHAREDIR}/libspeexdsp.${DEPENDENCY_EXT}.1
#		COMMAND ${CMAKE_CHRPATH} -c -r \\\$$ORIGIN ${FB_ROOTFS_DIR}/${LINPHONEWEB_SHAREDIR}/libssl.${DEPENDENCY_EXT}.1.0.0
		COMMAND ${CMAKE_CHRPATH} -c -r \\\$$ORIGIN ${FB_ROOTFS_DIR}/${LINPHONEWEB_SHAREDIR}/libswscale.${DEPENDENCY_EXT}.2
		COMMAND ${CMAKE_CHRPATH} -c -r \\\$$ORIGIN ${FB_ROOTFS_DIR}/${LINPHONEWEB_SHAREDIR}/libtheora.${DEPENDENCY_EXT}.0
		COMMAND ${CMAKE_CHRPATH} -c -r \\\$$ORIGIN ${FB_ROOTFS_DIR}/${LINPHONEWEB_SHAREDIR}/libv4l1.${DEPENDENCY_EXT}.0
		COMMAND ${CMAKE_CHRPATH} -c -r \\\$$ORIGIN ${FB_ROOTFS_DIR}/${LINPHONEWEB_SHAREDIR}/libv4l2.${DEPENDENCY_EXT}.0
		COMMAND ${CMAKE_CHRPATH} -c -r \\\$$ORIGIN ${FB_ROOTFS_DIR}/${LINPHONEWEB_SHAREDIR}/libv4lconvert.${DEPENDENCY_EXT}.0
		COMMAND ${CMAKE_CHRPATH} -c -r \\\$$ORIGIN ${FB_ROOTFS_DIR}/${LINPHONEWEB_SHAREDIR}/libvpx.${DEPENDENCY_EXT}.1
		COMMAND ${CMAKE_CHRPATH} -c -r \\\$$ORIGIN ${FB_ROOTFS_DIR}/${LINPHONEWEB_SHAREDIR}/libz.${DEPENDENCY_EXT}.1

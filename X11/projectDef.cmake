...
###############################################################################
# XPI Package
INSTALL(FILES ${CMAKE_CURRENT_SOURCE_DIR}/X11/XPI/install.rdf DESTINATION . COMPONENT ${PROJECT_NAME}-XPI)
INSTALL(TARGETS ${PROJECT_NAME} DESTINATION plugins COMPONENT ${PROJECT_NAME}-XPI)
INSTALL(FILES ${FB_BIN_DIR}/${PLUGIN_NAME}/${CMAKE_CFG_INTDIR}/linphoneweb_libs/libavcodec.so.53 DESTINATION plugins/linphoneweb_libs COMPONENT ${PROJECT_NAME}-XPI)
INSTALL(FILES ${FB_BIN_DIR}/${PLUGIN_NAME}/${CMAKE_CFG_INTDIR}/linphoneweb_libs/libavutil.so.51 DESTINATION plugins/linphoneweb_libs COMPONENT ${PROJECT_NAME}-XPI)
INSTALL(FILES ${FB_BIN_DIR}/${PLUGIN_NAME}/${CMAKE_CFG_INTDIR}/linphoneweb_libs/libjpeg.so.8 DESTINATION plugins/linphoneweb_libs COMPONENT ${PROJECT_NAME}-XPI)
INSTALL(FILES ${FB_BIN_DIR}/${PLUGIN_NAME}/${CMAKE_CFG_INTDIR}/linphoneweb_libs/libeXosip2.so.7 DESTINATION plugins/linphoneweb_libs COMPONENT ${PROJECT_NAME}-XPI)
INSTALL(FILES ${FB_BIN_DIR}/${PLUGIN_NAME}/${CMAKE_CFG_INTDIR}/linphoneweb_libs/liblinphone.so.5 DESTINATION plugins/linphoneweb_libs COMPONENT ${PROJECT_NAME}-XPI)
INSTALL(FILES ${FB_BIN_DIR}/${PLUGIN_NAME}/${CMAKE_CFG_INTDIR}/linphoneweb_libs/libmediastreamer.so.1 DESTINATION plugins/linphoneweb_libs COMPONENT ${PROJECT_NAME}-XPI)
INSTALL(FILES ${FB_BIN_DIR}/${PLUGIN_NAME}/${CMAKE_CFG_INTDIR}/linphoneweb_libs/libogg.so.0 DESTINATION plugins/linphoneweb_libs COMPONENT ${PROJECT_NAME}-XPI)
INSTALL(FILES ${FB_BIN_DIR}/${PLUGIN_NAME}/${CMAKE_CFG_INTDIR}/linphoneweb_libs/libortp.so.8 DESTINATION plugins/linphoneweb_libs COMPONENT ${PROJECT_NAME}-XPI)
INSTALL(FILES ${FB_BIN_DIR}/${PLUGIN_NAME}/${CMAKE_CFG_INTDIR}/linphoneweb_libs/libosip2.so.7 DESTINATION plugins/linphoneweb_libs COMPONENT ${PROJECT_NAME}-XPI)
INSTALL(FILES ${FB_BIN_DIR}/${PLUGIN_NAME}/${CMAKE_CFG_INTDIR}/linphoneweb_libs/libosipparser2.so.7 DESTINATION plugins/linphoneweb_libs COMPONENT ${PROJECT_NAME}-XPI)
INSTALL(FILES ${FB_BIN_DIR}/${PLUGIN_NAME}/${CMAKE_CFG_INTDIR}/linphoneweb_libs/libspeex.so.1 DESTINATION plugins/linphoneweb_libs COMPONENT ${PROJECT_NAME}-XPI)
INSTALL(FILES ${FB_BIN_DIR}/${PLUGIN_NAME}/${CMAKE_CFG_INTDIR}/linphoneweb_libs/libspeexdsp.so.1 DESTINATION plugins/linphoneweb_libs COMPONENT ${PROJECT_NAME}-XPI)
INSTALL(FILES ${FB_BIN_DIR}/${PLUGIN_NAME}/${CMAKE_CFG_INTDIR}/linphoneweb_libs/libswscale.so.2 DESTINATION plugins/linphoneweb_libs COMPONENT ${PROJECT_NAME}-XPI)
INSTALL(FILES ${FB_BIN_DIR}/${PLUGIN_NAME}/${CMAKE_CFG_INTDIR}/linphoneweb_libs/libtheora.so.0 DESTINATION plugins/linphoneweb_libs COMPONENT ${PROJECT_NAME}-XPI)
INSTALL(FILES ${FB_BIN_DIR}/${PLUGIN_NAME}/${CMAKE_CFG_INTDIR}/linphoneweb_libs/libv4l1.so.0 DESTINATION plugins/linphoneweb_libs COMPONENT ${PROJECT_NAME}-XPI)
INSTALL(FILES ${FB_BIN_DIR}/${PLUGIN_NAME}/${CMAKE_CFG_INTDIR}/linphoneweb_libs/libv4l2.so.0 DESTINATION plugins/linphoneweb_libs COMPONENT ${PROJECT_NAME}-XPI)
INSTALL(FILES ${FB_BIN_DIR}/${PLUGIN_NAME}/${CMAKE_CFG_INTDIR}/linphoneweb_libs/libv4lconvert.so.0 DESTINATION plugins/linphoneweb_libs COMPONENT ${PROJECT_NAME}-XPI)
INSTALL(FILES ${FB_BIN_DIR}/${PLUGIN_NAME}/${CMAKE_CFG_INTDIR}/linphoneweb_libs/libz.so.1 DESTINATION plugins/linphoneweb_libs COMPONENT ${PROJECT_NAME}-XPI)
...
INSTALL(FILES ${FB_BIN_DIR}/${PLUGIN_NAME}/${CMAKE_CFG_INTDIR}/linphoneweb_libs/libavcodec.so.53 DESTINATION linphoneweb_libs COMPONENT ${PROJECT_NAME}-TGZ)
INSTALL(FILES ${FB_BIN_DIR}/${PLUGIN_NAME}/${CMAKE_CFG_INTDIR}/linphoneweb_libs/libavutil.so.51 DESTINATION linphoneweb_libs COMPONENT ${PROJECT_NAME}-TGZ)
INSTALL(FILES ${FB_BIN_DIR}/${PLUGIN_NAME}/${CMAKE_CFG_INTDIR}/linphoneweb_libs/libjpeg.so.8 DESTINATION linphoneweb_libs COMPONENT ${PROJECT_NAME}-TGZ)
INSTALL(FILES ${FB_BIN_DIR}/${PLUGIN_NAME}/${CMAKE_CFG_INTDIR}/linphoneweb_libs/libeXosip2.so.7 DESTINATION linphoneweb_libs COMPONENT ${PROJECT_NAME}-TGZ)
INSTALL(FILES ${FB_BIN_DIR}/${PLUGIN_NAME}/${CMAKE_CFG_INTDIR}/linphoneweb_libs/liblinphone.so.5 DESTINATION linphoneweb_libs COMPONENT ${PROJECT_NAME}-TGZ)
INSTALL(FILES ${FB_BIN_DIR}/${PLUGIN_NAME}/${CMAKE_CFG_INTDIR}/linphoneweb_libs/libmediastreamer.so.1 DESTINATION linphoneweb_libs COMPONENT ${PROJECT_NAME}-TGZ)
INSTALL(FILES ${FB_BIN_DIR}/${PLUGIN_NAME}/${CMAKE_CFG_INTDIR}/linphoneweb_libs/libogg.so.0 DESTINATION linphoneweb_libs COMPONENT ${PROJECT_NAME}-TGZ)
INSTALL(FILES ${FB_BIN_DIR}/${PLUGIN_NAME}/${CMAKE_CFG_INTDIR}/linphoneweb_libs/libortp.so.8 DESTINATION linphoneweb_libs COMPONENT ${PROJECT_NAME}-TGZ)
INSTALL(FILES ${FB_BIN_DIR}/${PLUGIN_NAME}/${CMAKE_CFG_INTDIR}/linphoneweb_libs/libosip2.so.7 DESTINATION linphoneweb_libs COMPONENT ${PROJECT_NAME}-TGZ)
INSTALL(FILES ${FB_BIN_DIR}/${PLUGIN_NAME}/${CMAKE_CFG_INTDIR}/linphoneweb_libs/libosipparser2.so.7 DESTINATION linphoneweb_libs COMPONENT ${PROJECT_NAME}-TGZ)
INSTALL(FILES ${FB_BIN_DIR}/${PLUGIN_NAME}/${CMAKE_CFG_INTDIR}/linphoneweb_libs/libspeex.so.1 DESTINATION linphoneweb_libs COMPONENT ${PROJECT_NAME}-TGZ)
INSTALL(FILES ${FB_BIN_DIR}/${PLUGIN_NAME}/${CMAKE_CFG_INTDIR}/linphoneweb_libs/libspeexdsp.so.1 DESTINATION linphoneweb_libs COMPONENT ${PROJECT_NAME}-TGZ)
INSTALL(FILES ${FB_BIN_DIR}/${PLUGIN_NAME}/${CMAKE_CFG_INTDIR}/linphoneweb_libs/libswscale.so.2 DESTINATION linphoneweb_libs COMPONENT ${PROJECT_NAME}-TGZ)
INSTALL(FILES ${FB_BIN_DIR}/${PLUGIN_NAME}/${CMAKE_CFG_INTDIR}/linphoneweb_libs/libtheora.so.0 DESTINATION linphoneweb_libs COMPONENT ${PROJECT_NAME}-TGZ)
INSTALL(FILES ${FB_BIN_DIR}/${PLUGIN_NAME}/${CMAKE_CFG_INTDIR}/linphoneweb_libs/libv4l1.so.0 DESTINATION linphoneweb_libs COMPONENT ${PROJECT_NAME}-TGZ)
INSTALL(FILES ${FB_BIN_DIR}/${PLUGIN_NAME}/${CMAKE_CFG_INTDIR}/linphoneweb_libs/libv4l2.so.0 DESTINATION linphoneweb_libs COMPONENT ${PROJECT_NAME}-TGZ)
INSTALL(FILES ${FB_BIN_DIR}/${PLUGIN_NAME}/${CMAKE_CFG_INTDIR}/linphoneweb_libs/libv4lconvert.so.0 DESTINATION linphoneweb_libs COMPONENT ${PROJECT_NAME}-TGZ)
INSTALL(FILES ${FB_BIN_DIR}/${PLUGIN_NAME}/${CMAKE_CFG_INTDIR}/linphoneweb_libs/libz.so.1 DESTINATION linphoneweb_libs COMPONENT ${PROJECT_NAME}-TGZ)

...
if(LW_CREATE_SDK)
	...
	add_custom_target(${PLUGIN_NAME}${FB_SDK_PACKAGE_SUFFIX} ALL
		COMMAND ${CMAKE_COMMAND} "-DSDK_STAGE_DIR=${CMAKE_INSTALL_PREFIX}" "-DSDK_FILENAME=${FB_OUT_DIR}/${PROJECT_NAME}-${FBSTRING_PLUGIN_GIT_REVISION}-${FB_PACKAGE_SUFFIX}-sdk.zip" "-DSDK_PROJECT_SOURCE_DIR=${CMAKE_CURRENT_SOURCE_DIR}" "-DSDK_PROJECT_NAME=${PROJECT_NAME}" "-DSDK_PROJECT_VERSION=${FBSTRING_PLUGIN_VERSION}" -P ${CMAKE_CURRENT_SOURCE_DIR}/Common/sdk.cmake
		DEPENDS ${PLUGIN_NAME}

...
ADD_DEFINITIONS(
	...
	-DCORE_ROOTFS_VERSION="${CORE_ROOTFS_VERSION}"
	-std=c++0x
)
...
function (create_rootfs PROJNAME OUTDIR)
	...
	IF(LW_USE_G729)
		SET(ROOTFS_MS_PLUGINS_LIB_SOURCES
			...
			libmsbcg729.${DEPENDENCY_EXT}.0
		)
	ENDIF(LW_USE_G729)
	IF(LW_USE_X264)
		SET(ROOTFS_MS_PLUGINS_LIB_SOURCES
			${ROOTFS_MS_PLUGINS_LIB_SOURCES}
			libmsx264.${DEPENDENCY_EXT}.0
		)
	ENDIF(LW_USE_X264)
...
function (create_sdk_package PROJNAME PROJVERSION OUTDIR PROJDEP)
	...
	ADD_CUSTOM_COMMAND(OUTPUT ${OUTDIR}/${PROJECT_NAME}-${PROJVERSION}-${FB_PACKAGE_SUFFIX}-sdk.zip
				...
				COMMAND lp-gen-wrappers --output javascript --project linphone ${DOCUMENTATION}
				COMMAND mv linphone ${JSWRAPPER_DIR}/.
